...
1. Різниця між **new** та **init**
1. Спадкування, інкапсуляція, поліморфізм
1. Множинне спадкування
1. Магічні методи і навіщо вони треба
1. Абстрактні слоти
1. Навіщо треба слоти в класі
1. Метакласи, що таке і навіщо
...
1. Монолsт
1. Мsкросервиси
1. Перехід від моноліто до мікросервісів
